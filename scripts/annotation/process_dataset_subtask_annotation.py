...
if __name__ == "__main__":
    ...
    try:
        video_subtask_annotation.sync_dataset_subtask_annotation_content()
        video_subtask_annotation.process_dataset_subtask_annotation(args.api_key)

    except Exception:
        print(traceback.format_exc())

"""usages:
python -m scripts.annotation.process_dataset_subtask_annotation \
