...
if __name__ == "__main__":
    ...
    try:
        ...
        video_subtask_annotation.download_videos_multi_threads(num_workers=8)
        video_subtask_annotation.generate_url_video_file_hashes_multi_threads(num_workers=8)
        video_subtask_annotation.generate_url_video_image_hashes_multi_threads(num_workers=8)
...
"""usages:
python -m scripts.annotation.baai_subtask_annotation_pipeline \
