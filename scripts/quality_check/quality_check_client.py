...
from robocoin_dataset.quality_check.dataset_quality_check import DatasetQualityCheckClient
...
async def run_client_process(
    ...
    client = DatasetQualityCheckClient(
...
"""Usage:
python scripts/quality_check/quality_check_client.py \
    --host=127.0.0.1 \
    --port=2100 \
    --heartbeat-interval=10.0 \
    --log_dir=./logs/quality_check_client \
    --num-clients=8
"""
