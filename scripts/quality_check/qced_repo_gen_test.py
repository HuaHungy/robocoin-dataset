...
"""Usage:
python scripts/quality_check/qced_repo_gen_test.py --db_file_path ./db/datasets_new.db --log_dir ./logs/qced_repo_gen, --repo_path /mnt/nas/synnas/docker2/robocoin-datasets/G1edu-u3_bowl_storage_grape_multitry
"""
